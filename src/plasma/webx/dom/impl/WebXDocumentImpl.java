...
import plasma.webx.dom.WebXLangSpace;
import plasma.webx.dom.WebXRootElement;
import plasma.webx.util.WebXConstants;

public class WebXDocumentImpl extends AbstractStylableDocument
    implements WebXDocument, WebXConstants, CSSNavigableDocument, IdContainer {
  private static final long serialVersionUID = -4975369126315494525L;

  /**
   * The error messages bundle class name.
   */
  protected static final String RESOURCES =
      "plasma.webx.dom.webx.resources.Messages";
   ...
   */
//   protected AnimatedAttributeListener mainAnimatedAttributeListener = new
//   AnimAttrListener();
   ...
   */
  protected WebXDocumentImpl() {
  }

  /**
   * Creates a new document.
   */
  public WebXDocumentImpl(DocumentType dt, DOMImplementation impl) {
    super(dt, impl);
  }
...
/*
      for (Node n = getDocumentElement().getFirstChild();
          ...
          if (ns != null && ns.equals(WEBX_NAMESPACE_URI)) {
              if (n.getLocalName().equals(WEBX_TITLE_TAG)) {
                  preserve = ((WebXLangSpace)n).getXMLspace().equals("preserve");
...
//@formatter:on
      ...
      String ns = n.getNamespaceURI();
      if (ns != null && ns.equals(WEBX_NAMESPACE_URI)) {
        sb.append(n.getAttributes().getNamedItem(ns));
      }
   ...
   */
  @Override
  public WebXRootElement getRootElement() {
      return (WebXRootElement)getDocumentElement();
  }
  ...
  public Element createElementNS(String namespaceURI, String qualifiedName)
      throws DOMException {
      WebXDOMImplementation impl = (WebXDOMImplementation)implementation;
  ...
  public boolean isId(Attr node) {
      if (node.getNamespaceURI() == null) {
          return WEBX_ID_ATTRIBUTE.equals(node.getNodeName());
      }
...
//CSSNavigableDocument ///////////////////////////////////////////
   ...
   */
//TODO  protected AnimatedAttributeListener getAnimatedAttributeListener() {
...
//  }
   ...
   */
//TODO  public void addAnimatedAttributeListener
...
//  }
   ...
   */
//TODO  public void removeAnimatedAttributeListener
//          (AnimatedAttributeListener aal) {
...
//  }
   ...
   */
//TODO  protected class AnimAttrListener implements AnimatedAttributeListener {
//
//      /**
...
//DocumentCSS ////////////////////////////////////////////////////////////
  ...
  public CSSStyleDeclaration getOverrideStyle(Element elt,
                                              String pseudoElt) {
      if (elt instanceof WebXStylableElement && pseudoElt == null) {
          return ((WebXStylableElement) elt).getOverrideStyle();
      }
      return null;
  }
...
//AbstractDocument ///////////////////////////////////////////////
  ...
  protected Node copyInto(Node n) {
      super.copyInto(n);
      WebXDocumentImpl sd = (WebXDocumentImpl)n;
