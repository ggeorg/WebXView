...
/**
 * Abstract class for WebX type related constants.  These maybe should
 * move into o.a.b.util.WebXConstants.
 */
public abstract class WebXTypes {
  
  // Constants for WebX attribute and property types
